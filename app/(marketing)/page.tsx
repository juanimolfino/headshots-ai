...
export const metadata: Metadata = {
  title: {
    absolute: "AI Headshot Generator — Studio Quality in Minutes | Headshots AI",
  },
  description:
  ...
  openGraph: {
    title: "AI Headshot Generator — Studio Quality in Minutes | Headshots AI",
    description:
      "Upload your selfies and get professional AI headshots for LinkedIn, resumes, and your website. Personal model trained on your face. Ready in 10 minutes. From $5.90.",
    url: "/",
    type: "website",
...
const CONTACT_EMAIL = "juanimolfinooo@gmail.com";
...
// Linkifica el email de contacto en la respuesta de reembolso; texto plano si no.
...
export default function LandingPage() {
  return (
    ...
    // bg-bg/text-ink: fondo cálido del design system (el body shadcn es blanco).
    <div className="js min-h-screen bg-bg leading-[1.6] text-ink">
      <noscript>
          ...
          <div className="wrap">
            <Reveal className="panel-navy">
              <div className="sec-head">
                <Eyebrow>Why Headshots AI</Eyebrow>

// =========================================================
// headshotly.pro — content (single source of truth)
// All copy is final. Image slots are placeholders; see
// components/Placeholder.tsx for the swap-to-<Image> note.
// =========================================================
...
export const FAQ = [
  ...
  },
  {
    ...
    a: "If your model fails to train or results are unusable, we'll refund you or retrain at no cost. Reach out at hello@headshotly.pro.",
  },
];
